...
Pod::Spec.new do |s|
  s.name             = 'testpod'
  s.version          = '0.0.1'
  s.summary          = 'A testpod to prove I can make one.'
...
A long description to shut up lint.
  ...
  s.homepage         = 'https://github.com/lukeward/testpod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Luke Ward' => 'lward@us.ci.org' }
  s.source           = { :git => 'https://github.com/lukeward/testpod.git', :tag => s.version.to_s }
